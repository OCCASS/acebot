...
class BaseForm:
    ...
    @classmethod
    async def get_keyboard(cls, row_width=1, exceptions=None, locale=None) -> ReplyKeyboardMarkup:
        """
        :param row_width:
        ...
        fields = [_(field.text, locale=locale) for field in cls.fields if field.id not in exceptions]
    ...
    @classmethod
    async def get_inline_keyboard(cls, callback_data=None, callback_data_args=None, row_width=1, exceptions=None):
