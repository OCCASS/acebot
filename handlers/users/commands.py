...
@dp.message_handler(is_likes_seen=True, commands=['start'], state='*')
...
@dp.message_handler(is_likes_seen=True, commands=['change_match'], state='*')
...
@dp.message_handler(is_likes_seen=True, commands=['help'], state='*')
async def help_command(message: types.Message, state: FSMContext):
    await send_help_message()


@dp.message_handler(is_admin=True, is_likes_seen=True, commands=['message_to_subs'], state='*')
